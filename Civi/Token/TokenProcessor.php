...
class TokenProcessor {
  ...
  public function getTokens() {
    if ($this->tokens === NULL) {
      ...
      $this->dispatcher->dispatchEvent('civi.token.list', $event);
    }
    return $this->tokens;
  }
  ...
  public function evaluate() {
    ...
    $this->dispatcher->dispatchEvent('civi.token.eval', $event);
    return $this;
  }
  ...
  public function render($name, $row) {
    ...
    $this->dispatcher->dispatchEvent('civi.token.render', $event);
    return $event->string;
  }
