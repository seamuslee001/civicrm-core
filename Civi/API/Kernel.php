...
class Kernel {
  ...
  public function runSafe($entity, $action, $params) {
    ...
    try {
      ...
      if ($apiRequest) {
        $this->dispatcher->dispatchEvent('civi.api.exception', new ExceptionEvent($e, NULL, $apiRequest, $this));
      }
  ...
  public function resolve($apiRequest) {
    ...
    $resolveEvent = $this->dispatcher->dispatchEvent('civi.api.resolve', new ResolveEvent($apiRequest, $this));
  ...
  public function authorize($apiProvider, $apiRequest) {
    ...
    $event = $this->dispatcher->dispatchEvent('civi.api.authorize', new AuthorizeEvent($apiProvider, $apiRequest, $this));
  ...
  public function prepare($apiProvider, $apiRequest) {
    ...
    $event = $this->dispatcher->dispatchEvent('civi.api.prepare', new PrepareEvent($apiProvider, $apiRequest, $this));
  ...
  public function respond($apiProvider, $apiRequest, $result) {
    ...
    $event = $this->dispatcher->dispatchEvent('civi.api.respond', new RespondEvent($apiProvider, $apiRequest, $result, $this));
