 ...
 * (GenCodeChecksum:303813bc5124f9fb6c4774d8320f0366)
 */
...
class CRM_Event_DAO_Event extends CRM_Core_DAO {
  ...
  /**
   * Public Event Title (e.g. Fall Fundraiser Dinner)
   *
   * @var string
   */
  ...
  public static function &fields() {
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'event_frontend_title' => [
          'name' => 'frontend_title',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => ts('Public Event Title'),
          'description' => ts('Public Event Title (e.g. Fall Fundraiser Dinner)'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
          'import' => TRUE,
          'where' => 'civicrm_event.frontend_title',
          'headerPattern' => '/(event.)?frontend_title$/i',
          'export' => TRUE,
          'default' => 'NULL',
          'table_name' => 'civicrm_event',
          'entity' => 'Event',
